...
1. Clone the repository generated by Github after joining the class and accepte the assingment.

2. In a terminal window, navigate into your projectOne directory.
